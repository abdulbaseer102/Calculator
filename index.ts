...
.prompt({
     ...
     message:"Do you want to restart Y Or N:"
        ...
        again.Restart == 'Y '|| again.Restart == 'y'|| again.Restart == 'yes'|| again.Restart == 'Yes' || again.Restart == 'YES' || again.Restart == 'No' ||  again.Restart == 'no' || again.Restart == 'No' ||again.Restart == 'NO'
